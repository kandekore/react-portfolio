    ...
    <Card className="text-center">
      ...
      <Card.Body>
        ...
        >
          <div class="row g-0">
            <div class="col-md-4">
              <Card.Img src="http://localhost:3000/assets/images/darren10k.JPG" />
            </div>
            <div class="col-md-8">
                  ...
                  >
                    <Tab eventKey="profile" title="Overview">
                      <p style={{ textAlign: "justify" }}>
                        I am a driven, dedicated, and innovative individual with
                        a passion for creating and managing web applications and
                      ...
                      <p style={{ textAlign: "justify" }}>
                        After teaching myself HTML and Search engine
                        Optimisation, in 2009 I became self employed offering
                        website design and Search Engine Marketing services to
                        small businesses and created ‘scrapacarforcash.co.uk’ a
                        lead generation website for scrap car and salvage
                        businesses, this project was very successful and is
                        running right up until the present day.
                      </p>
                      <p style={{ textAlign: "justify" }}>
                        My Portfolio of clients enabled me to start my own
                        hosting platform, offering website hosting & email
                        services including Exchange & Microsoft 365.
                      </p>
                      <p style={{ textAlign: "justify" }}>
                        A keen runner, I recently raised £900 for Acorns
                        Childrens Hospice by taking part in the Great Birmingham
                        Run, I am an Aston Villa season ticket holder and enjoy
